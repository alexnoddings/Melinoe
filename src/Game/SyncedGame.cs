...
public class SyncedGame
{
	...
	private static class AllGhosts
	{
		public static Ghost[] Array => new Ghost[]
		{
			...
			new(GhostType.Deogen, EvidenceType.SpiritBox | EvidenceType.GhostWriting | EvidenceType.DotsProjector),
			...
			new(GhostType.Thaye, EvidenceType.GhostOrbs | EvidenceType.GhostWriting | EvidenceType.DotsProjector),
